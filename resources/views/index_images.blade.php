                    ...
                    <div class="p-0">
                        <div class="card ">
                            ...
                            <div class="card-body" style="">
                                <img class="img-fluid image-cover" src="{{('/home/forge/boliviandev.xyz/public'.$ful_image[0]->url)}}" alt="">
                                <script>
                                    console.log({{\Illuminate\Support\Js::from(asset('/public'.$ful_image[0]->url))}})
                                </script>
                            </div>
                        </div>
                    </div>
